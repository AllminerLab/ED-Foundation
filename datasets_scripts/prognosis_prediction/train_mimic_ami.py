#!/usr/bin/env python3
"""
MIMIC-IV-ED-AMI training script.
In-hospital mortality prediction for MIMIC-IV ED AMI patients; binary classification task.
"""
...
class MIMICAMIDataset(Dataset):
    """MIMIC-IV-ED-AMI dataset for mortality prediction."""
    def __init__(self, data_path, tokenizer, max_length=512):
        ...
        print(f"Class distribution: Survival={len(self.data[self.data['label']==0])}, Mortality={len(self.data[self.data['label']==1])}")
...
def main():
    ...
    print("="*80)
    print("MIMIC-IV-ED-AMI training - in-hospital mortality prediction")
    print("="*80 + "\n")
