...
class SYSMHOutcomeDataset(Dataset):
    ...
    def __init__(self, data_path, tokenizer, max_length=512):
        ...
        print(f"类别分布: Not admitted={label_counts.get(0, 0)}, Admitted={label_counts.get(1, 0)}")
...
def main():
    ...
    print("="*80)
    print("SYSMH-ED-Outcome 训练 - 住院预测")
    print("="*80 + "\n")
