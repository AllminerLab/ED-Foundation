#!/usr/bin/env python3
"""
MIMIC-IV-ED-Outcome 训练脚本
多模态(文本+ECG)多任务学习
任务: 1)住院预测 2)停留时间 3)严重评分
"""
...
class MIMICOutcomeDataset(Dataset):
    ...
    def __init__(self, data_path, ecg_dir, tokenizer, max_length=512):
        ...
        print(f"加载 {len(self.data)} 条多模态数据")
    ...
    def __getitem__(self, idx):
        ...
        try:
            ...
            pixel_values = torch.zeros(3, 224, 224)  # 缺失图像用零填充
...
def main():
    ...
    parser.add_argument('--ecg_dir', type=str, required=True, help='ECG图像目录')
    ...
    print("="*80)
    print("MIMIC-IV-ED-Outcome 训练 - 多模态多任务")
    print("="*80 + "\n")
