...
The repository does not include restricted clinical data or full pretrained weights.
Private SYSMH and GTCMH data require institutional data-use agreements. MIMIC data
require PhysioNet credentialed access. Full model weights are available upon
request because the weight file is too large to include directly in the repository.
